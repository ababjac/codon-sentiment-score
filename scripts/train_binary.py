...
model = KerasClassifier(model=sentiment_model.create_model, epochs=1, verbose=1, validation_split=0.2, lstm_units1=16, lstm_units2=3, neurons_dense1=8, neurons_dense2=3, dropout_rate=0.1, embedding_size=16, max_text_len=helpers.VOCAB_SIZE, learning_rate=0.001)
...
result = model.fit(X_train_seq, y_train)
...
test_loss, test_auc, test_acc, test_precision, test_recall = model.model_.evaluate(X_test_seq, y_test)
