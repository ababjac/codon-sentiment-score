...
model = BertRegresser.from_pretrained('./models/codonBERT-multi_1/checkpoint-99500', config=config)
#optimizer = torch.optim.Adam(params=model.parameters())

training_args = TrainingArguments(
    output_dir='./models/codonBERT-multi_reg'.format(RUN),
    learning_rate=2e-6,
...
with open('./results/codonBERT-multi_reg.txt'.format(RUN),'w') as data: 
