...
model = AutoModelForSequenceClassification.from_pretrained('./models/codonBERT_binary_reg_Musmusculus-pre-norm2/checkpoint-63222/')
...
with open('./results/codonBERT_binary_reg_labels_{}-pre-norm2.txt'.format(SPECIES),'w') as data:
    for val in labels:
        data.write(str(val)+'\n')
